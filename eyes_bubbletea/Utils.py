...
class Utils:
    ...
    def preprocess_data(self, data_type, file_format='tif'):
    ...
    def train_model(self, X_train, Y_train, X_test, Y_test):
        ...
        figure,locations = plt.subplots(1,2, figsize=(8, 4))

        locations[0].plot(R.history['accuracy'],"y",label='training_accuracy')
        locations[0].plot(R.history['val_accuracy'],"r",label='validation_accuracy')
        locations[0].set_ylabel('accuracy over time')
        locations[0].set_xlabel('time')
        locations[0].legend(loc=0)

        locations[1].plot(R.history['loss'],"y",label='training_loss')
        locations[1].plot(R.history['val_loss'],"r",label='validation_loss')
        locations[1].set_ylabel('loss over time')
        locations[1].set_xlabel('time')
        locations[1].legend(loc=0)
